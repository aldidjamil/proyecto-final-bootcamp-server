...
const { getAllRecipes, getRecipeOwner, getRecipeById, addRecipe, deleteRecipe, editRecipe } = require("../controllers/recipes.controllers")

router.get("/getAllRecipes", getAllRecipes)
router.get("/owner", getRecipeOwner)
